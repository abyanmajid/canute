      ...
      <div className="py-24 px-4 mx-auto max-w-screen-xl">
        <div className="border-gray-500  bg-gray-800 bg-opacity-35 border rounded-lg p-8 md:p-12 mb-8">
          <div className="text-center">
            ...
            <h1 className="text-white text-4xl font-extrabold mb-6 mt-4">
              Your Results
            </h1>
            ...
            <div className="justify-evenly">
              <button
                ...
                type="button"
                className="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-cyan-800"
              >
                Post on Leaderboard
              </button>
            </div>
